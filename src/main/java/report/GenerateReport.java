...
public class GenerateReport{
    //region REPORT
    private static String genTCReportFile(String folder,String subFolder,String reportName) throws IOException{
    ...
    public static String genReport(String folderName,String reportName)throws IOException{
